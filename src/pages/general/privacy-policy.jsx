...
const PrivacyTemplate = () => {
  return (
    <Box>
      <Header />
      <Box py={"4%"} px={{ md: "8%", base: "2%" }}>
        <Box textAlign={"center"}>
          <Heading variant={"h2"} color={"gray.text"}>
            Privacy Policy
          </Heading>
        </Box>
        <Box
        ...
        >
          <Box>
            <Heading variant={"p4"} color={"gray.text"} fontWeight={"bold"}>
          ...
          <Box mt={"6%"}>
            <Heading fontWeight={"bold"} variant={"p6"} color={"gray.text"}>
            ...
            <Heading mt={"2%"} variant={"p4"} color={"gray.text"}>
